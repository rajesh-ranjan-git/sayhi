...
const ProfileContextRightContent = () => {
  return (
    <div className="flex flex-col gap-2 bg-neutral-600 p-3 rounded-r-md w-[60%] h-full text-white">
...
export default ProfileContextRightContent;
